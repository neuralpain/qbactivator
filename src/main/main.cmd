...
copy /v /y /z "%CLIENTFOLDER%\Intuit.Spc.Map.EntitlementClient.Common.dll.bak" "%CLIENTFOLDER%\Intuit.Spc.Map.EntitlementClient.Common.dll" >nul
fc "%CLIENTFOLDER%\Intuit.Spc.Map.EntitlementClient.Common.dll" "%CLIENTFOLDER%\Intuit.Spc.Map.EntitlementClient.Common.dll.bak" > nul
...
if %ERRORLEVEL% EQU 1 (
  ...
  del /q /f /a "%CLIENTFOLDER%\Intuit.Spc.Map.EntitlementClient.Common.dll.bak"
  cls & echo.
