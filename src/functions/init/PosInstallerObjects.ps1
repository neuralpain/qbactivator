$POS11InstObj = [Installer]@{
  ...
  Url         = 'https://dlm2.download.intuit.com/akdlm/SBD/QuickBooks/2013/Latest/QuickBooksPOSV11.exe'
...
$POS12InstObj = [Installer]@{
  ...
  Url         = 'https://dlm2.download.intuit.com/akdlm/SBD/QuickBooks/2015/Latest/QuickBooksPOSV12.exe'
...
$POS18InstObj = [Installer]@{
  ...
  Url         = 'https://dlm2.download.intuit.com/akdlm/SBD/QuickBooks/2018/Latest/QuickBooksPOSV18.exe'
